    ...
    <Routes>
      ...
      <Route path="/medicine/:id" element={
        <RoleRoute 
          ...
          allowedRoles={['manufacturer', 'distributor', 'regulator', 'enduser']} 
        />
      } />
      
      <Route path="/scan-medicine" element={
        <RoleRoute 
      ...
      <Route path="/scan-medicine/:id" element={
        <RoleRoute 
          element={<ScanMedicine />} 
          allowedRoles={['manufacturer', 'distributor', 'regulator', 'enduser']} 
        />
      ...
      <Route path="/flag-medicine/:id" element={
        <RoleRoute 
      ...
      <Route path="/generate-qr/:id" element={
        <RoleRoute 
      ...
      <Route path="/manufacturer/view" element={
        <RoleRoute 
      ...
      <Route path="/manufacturer/register-distributor" element={
        <RoleRoute 
      ...
      <Route path="/manufacturer/manage-distributors" element={
        <RoleRoute 
